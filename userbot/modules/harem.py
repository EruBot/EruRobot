...
async def typewriter(typew):
    ...
    sleep(0)
    await typew.edit("shiki yi medb osakabehime kiyohime Nightingale yu ke Hokusai Carmilla Mysterious Mae drake europa")
    sleep(0)
    await typew.edit("boudica chacha circe medea murasaki kiara ishtar jeanne jane bradamante brynhildr tomoe gozen")
    sleep(0)
    await typew.edit("irisviel von katou medusa parvati orion stheno euryale nero kingprotea hassan yang abigail")
    sleep(0)
    await typew.edit("illyasviel ereshkigal bb charlotte tamamo chiyome minamoto wu helena ibaraki okita oda mash astolfo")
    sleep(0)
    await typew.edit("mordred nitocris gorgon paul benienma mecha elisabeth gray jack marie anastasia passionlip")
    sleep(0)
    await typew.edit("scheherazade semiramis salome lakshmibai valkyrie anne da fujino nagao")
    sleep(0)
